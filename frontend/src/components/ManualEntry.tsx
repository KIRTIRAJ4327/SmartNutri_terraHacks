    ...
    return (
      <div className="flex flex-col items-center justify-center py-12">
        ...
        <p className="text-sm text-gray-500 mt-2">
          {userPreferences
            ? `Personalizing for ${userPreferences.goal.replace("_", " ")} goal`
    ...
    <div className="bg-white rounded-lg shadow-lg p-6">
      <div className="flex items-center mb-6">
        ...
        <div>
          ...
          <p className="text-gray-600">
            Enter products you've purchased or consumed
          </p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <select
                  ...
                  onChange={(e) =>
                    updateProduct(
                      index,
                      "unit",
                      e.target.value as ManualProduct["unit"]
                    )
                  }
        ...
        >
          ...
          Analyze Nutrition
          {userPreferences && (
            <span className="ml-2 text-blue-200">(Personalized)</span>
          )}
        </button>
      </form>
      ...
      <div className="mt-4 text-center space-y-2">
        <p className="text-gray-500 text-sm">
          💡 Tip: We get the best results with fruits, vegetables, and simple
          proteins
        </p>
